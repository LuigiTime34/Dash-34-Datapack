...
execute positioned 4 -59 146 run summon ravager ~ ~ ~ {CustomNameVisible:1b,Health:750,NoAI:1b,Rotation:[90f,0.0f],Tags:["defense-monster","cw_hp_disp","defense-ravager","Entity-Dummy"],Team:defense_enemies,attributes:[{id:"max_health",base:750},{id:"minecraft:attack_damage",base:100},{id:"minecraft:attack_knockback",base:125}]}

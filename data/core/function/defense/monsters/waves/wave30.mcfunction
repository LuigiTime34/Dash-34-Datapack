...
execute if score $wave_track defense.wave matches 14 run function core:defense/monsters/boss/ravager/summon
...
execute if score $wave_track defense.wave matches 1..16 run schedule function core:defense/monsters/waves/wave30 30t

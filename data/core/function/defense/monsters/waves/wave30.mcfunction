...
execute if score $wave_track defense.wave matches 11 run function core:defense/monsters/boss/ravager/summon
execute if score $wave_track defense.wave matches 1..10 run schedule function core:defense/monsters/waves/wave30 3s

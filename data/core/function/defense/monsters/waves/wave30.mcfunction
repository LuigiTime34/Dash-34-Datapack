...
execute if score $wave_track defense.wave matches 5 run function core:defense/monsters/summon/skeleton_horse
...
execute if score $wave_track defense.wave matches 9 run function core:defense/monsters/boss/giant/summon

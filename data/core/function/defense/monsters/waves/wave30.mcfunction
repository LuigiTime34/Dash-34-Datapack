...
execute if score $wave_track defense.wave matches 11 run function core:defense/monsters/summon/hoglin
execute if score $wave_track defense.wave matches 12 run function core:defense/monsters/summon/charged_creeper
execute if score $wave_track defense.wave matches 13 run function core:defense/monsters/boss/ravager/summon
execute if score $wave_track defense.wave matches 1..13 run schedule function core:defense/monsters/waves/wave30 3s

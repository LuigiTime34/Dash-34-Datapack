...
execute if score $wave_track defense.wave matches 3 run function core:defense/monsters/boss/giant/summon
...
execute if score $wave_track defense.wave matches 14 run function core:defense/monsters/summon/iron_golem

...
execute if score $wave_track defense.wave matches 14 run function core:defense/monsters/summon/zoglin
execute if score $wave_track defense.wave matches 1..14 run schedule function core:defense/monsters/waves/wave36 30t

...
execute if score $wave_track defense.wave matches 1 run function core:defense/monsters/summon/husk
execute if score $wave_track defense.wave matches 2 run function core:defense/monsters/summon/husk
...
execute if score $wave_track defense.wave matches 1..8 run schedule function core:defense/monsters/waves/wave14 3s

...
execute if score $wave_track defense.wave matches 15 run function core:defense/monsters/summon/pillager
...
execute if score $wave_track defense.wave matches 1..19 run schedule function core:defense/monsters/waves/wave27 3s

...
execute if score $wave_track defense.wave matches 3 run function core:defense/monsters/summon/charged_creeper
...
execute if score $wave_track defense.wave matches 1..9 run schedule function core:defense/monsters/waves/wave42 3s

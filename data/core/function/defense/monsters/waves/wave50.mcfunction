...
execute if score $wave_track defense.wave matches 4 run function core:defense/monsters/boss/warden/summon
...
execute if score $wave_track defense.wave matches 1..7 run schedule function core:defense/monsters/waves/wave50 15t

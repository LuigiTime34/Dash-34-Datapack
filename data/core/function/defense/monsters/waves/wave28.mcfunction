...
execute if score $wave_track defense.wave matches 13 run function core:defense/monsters/summon/husk
...
execute if score $wave_track defense.wave matches 1..16 run schedule function core:defense/monsters/waves/wave28 3s

...
execute if score $wave_track defense.wave matches 10 run function core:defense/monsters/summon/husk
execute if score $wave_track defense.wave matches 11 run function core:defense/monsters/summon/husk
execute if score $wave_track defense.wave matches 12 run function core:defense/monsters/summon/hoglin
...
execute if score $wave_track defense.wave matches 16 run function core:defense/monsters/summon/skeleton_horse

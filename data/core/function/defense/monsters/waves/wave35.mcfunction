...
execute if score $wave_track defense.wave matches 6 run function core:defense/monsters/summon/bogged
...
execute if score $wave_track defense.wave matches 1..14 run schedule function core:defense/monsters/waves/wave35 30t

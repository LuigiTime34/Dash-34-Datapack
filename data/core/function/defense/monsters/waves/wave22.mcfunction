...
execute if score $wave_track defense.wave matches 4 run function core:defense/monsters/summon/zombie_villager
execute if score $wave_track defense.wave matches 5 run function core:defense/monsters/summon/witch
execute if score $wave_track defense.wave matches 1..5 run schedule function core:defense/monsters/waves/wave22 3s

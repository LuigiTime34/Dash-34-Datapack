...
execute if score $wave_track defense.wave matches 4 run function core:defense/monsters/summon/charged_creeper
...
execute if score $wave_track defense.wave matches 1..9 run schedule function core:defense/monsters/waves/wave44 3s

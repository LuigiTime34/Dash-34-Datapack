...
execute if score $wave_track defense.wave matches 7 run function core:defense/monsters/summon/breeze
execute if score $wave_track defense.wave matches 8 run function core:defense/monsters/summon/breeze
execute if score $wave_track defense.wave matches 9 run function core:defense/monsters/summon/skeleton_horse
execute if score $wave_track defense.wave matches 10 run function core:defense/monsters/summon/skeleton_horse
execute if score $wave_track defense.wave matches 11 run function core:defense/monsters/summon/zombified_piglin
execute if score $wave_track defense.wave matches 1..11 run schedule function core:defense/monsters/waves/wave23 3s

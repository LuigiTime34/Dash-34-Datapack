...
execute if score $wave_track defense.wave matches 35 run function core:defense/monsters/summon/witch
execute if score $wave_track defense.wave matches 36 run function core:defense/monsters/summon/witch
execute if score $wave_track defense.wave matches 1..36 run schedule function core:defense/monsters/waves/wave24 3s

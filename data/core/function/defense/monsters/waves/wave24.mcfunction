...
execute if score $wave_track defense.wave matches 4 run function core:defense/monsters/summon/zombified_piglin
...
execute if score $wave_track defense.wave matches 7 run function core:defense/monsters/summon/skeleton
...
execute if score $wave_track defense.wave matches 1..16 run schedule function core:defense/monsters/waves/wave24 30t

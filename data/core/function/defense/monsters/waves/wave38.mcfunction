...
execute if score $wave_track defense.wave matches 21 run function core:defense/monsters/summon/creeper
...
execute if score $wave_track defense.wave matches 1..26 run schedule function core:defense/monsters/waves/wave38 30t

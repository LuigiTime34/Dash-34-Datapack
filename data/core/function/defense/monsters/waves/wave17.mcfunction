...
execute if score $wave_track defense.wave matches 1 run function core:defense/monsters/summon/zombie_villager
...
execute if score $wave_track defense.wave matches 5 run function core:defense/monsters/summon/husk
execute if score $wave_track defense.wave matches 6 run function core:defense/monsters/summon/witch
execute if score $wave_track defense.wave matches 1..6 run schedule function core:defense/monsters/waves/wave17 3s

...
execute if score $wave_track defense.wave matches 6 run function core:defense/monsters/summon/piglin
...
execute if score $wave_track defense.wave matches 1..11 run schedule function core:defense/monsters/waves/wave17 3s

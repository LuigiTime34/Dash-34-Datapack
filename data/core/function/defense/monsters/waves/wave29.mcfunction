...
execute if score $wave_track defense.wave matches 19 run function core:defense/monsters/summon/breeze
execute if score $wave_track defense.wave matches 1..19 run schedule function core:defense/monsters/waves/wave29 3s

...
execute if score $wave_track defense.wave matches 11 run function core:defense/monsters/summon/pillager
execute if score $wave_track defense.wave matches 12 run function core:defense/monsters/summon/pillager
execute if score $wave_track defense.wave matches 13 run function core:defense/monsters/summon/pillager
...
execute if score $wave_track defense.wave matches 18 run function core:defense/monsters/summon/enderman
execute if score $wave_track defense.wave matches 19 run function core:defense/monsters/summon/enderman
execute if score $wave_track defense.wave matches 20 run function core:defense/monsters/summon/enderman
execute if score $wave_track defense.wave matches 21 run function core:defense/monsters/summon/enderman
...
execute if score $wave_track defense.wave matches 1..23 run schedule function core:defense/monsters/waves/wave29 3s

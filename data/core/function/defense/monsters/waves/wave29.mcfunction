...
execute if score $wave_track defense.wave matches 16 run function core:defense/monsters/summon/hoglin
execute if score $wave_track defense.wave matches 17 run function core:defense/monsters/summon/hoglin
execute if score $wave_track defense.wave matches 18 run function core:defense/monsters/summon/charged_creeper
execute if score $wave_track defense.wave matches 1..18 run schedule function core:defense/monsters/waves/wave29 3s

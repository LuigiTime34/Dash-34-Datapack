...
execute if score $wave_track defense.wave matches 21 run function core:defense/monsters/summon/blaze
...
execute if score $wave_track defense.wave matches 25 run function core:defense/monsters/summon/piglin_brute
execute if score $wave_track defense.wave matches 26 run function core:defense/monsters/summon/piglin_brute
execute if score $wave_track defense.wave matches 27 run function core:defense/monsters/summon/piglin_brute
execute if score $wave_track defense.wave matches 28 run function core:defense/monsters/summon/piglin_brute
...
execute if score $wave_track defense.wave matches 31 run function core:defense/monsters/summon/vindicator
execute if score $wave_track defense.wave matches 32 run function core:defense/monsters/summon/vindicator
execute if score $wave_track defense.wave matches 33 run function core:defense/monsters/summon/vindicator
execute if score $wave_track defense.wave matches 34 run function core:defense/monsters/summon/vindicator
execute if score $wave_track defense.wave matches 35 run function core:defense/monsters/summon/vindicator
execute if score $wave_track defense.wave matches 1..35 run schedule function core:defense/monsters/waves/wave29 3s

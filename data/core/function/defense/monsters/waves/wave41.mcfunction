...
execute if score $wave_track defense.wave matches 2 run function core:defense/monsters/summon/witch
execute if score $wave_track defense.wave matches 3 run function core:defense/monsters/summon/creeper
...
execute if score $wave_track defense.wave matches 1..9 run schedule function core:defense/monsters/waves/wave41 15t

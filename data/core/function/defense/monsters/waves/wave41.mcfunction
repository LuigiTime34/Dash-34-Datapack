...
execute if score $wave_track defense.wave matches 8 run function core:defense/monsters/summon/iron_golem
...
execute if score $wave_track defense.wave matches 14 run function core:defense/monsters/summon/bogged
...
execute if score $wave_track defense.wave matches 23 run function core:defense/monsters/summon/creeper
execute if score $wave_track defense.wave matches 24 run function core:defense/monsters/summon/creeper
...
execute if score $wave_track defense.wave matches 29 run function core:defense/monsters/summon/skeleton
execute if score $wave_track defense.wave matches 1..29 run schedule function core:defense/monsters/waves/wave41 15t

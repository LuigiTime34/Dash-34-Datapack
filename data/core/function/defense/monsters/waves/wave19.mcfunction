...
execute if score $wave_track defense.wave matches 9 run function core:defense/monsters/summon/piglin
...
execute if score $wave_track defense.wave matches 1..12 run schedule function core:defense/monsters/waves/wave19 3s

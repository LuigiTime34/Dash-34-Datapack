...
execute if score $wave_track defense.wave matches 3 run function core:defense/monsters/summon/zombie_villager
...
execute if score $wave_track defense.wave matches 1..5 run schedule function core:defense/monsters/waves/wave16 3s

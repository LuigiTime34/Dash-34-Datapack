...
execute if score $wave_track defense.wave matches 12 run function core:defense/monsters/summon/spider
execute if score $wave_track defense.wave matches 1..12 run schedule function core:defense/monsters/waves/wave16 3s

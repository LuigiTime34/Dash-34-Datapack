...
execute if score $wave_track defense.wave matches 4 run function core:defense/monsters/summon/witch
execute if score $wave_track defense.wave matches 5 run function core:defense/monsters/summon/witch
execute if score $wave_track defense.wave matches 6 run function core:defense/monsters/summon/zombie_villager
execute if score $wave_track defense.wave matches 7 run function core:defense/monsters/summon/zombie_villager
...
execute if score $wave_track defense.wave matches 10 run function core:defense/monsters/summon/breeze
execute if score $wave_track defense.wave matches 11 run function core:defense/monsters/summon/breeze
execute if score $wave_track defense.wave matches 12 run function core:defense/monsters/summon/skeleton_horse
execute if score $wave_track defense.wave matches 13 run function core:defense/monsters/summon/charged_creeper
execute if score $wave_track defense.wave matches 14 run function core:defense/monsters/summon/charged_creeper
execute if score $wave_track defense.wave matches 1..14 run schedule function core:defense/monsters/waves/wave25 3s

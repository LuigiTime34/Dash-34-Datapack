...
execute if score $wave_track defense.wave matches 15 run function core:defense/monsters/summon/zombie_villager
execute if score $wave_track defense.wave matches 1..15 run schedule function core:defense/monsters/waves/wave10 3s

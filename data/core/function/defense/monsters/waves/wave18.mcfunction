...
execute if score $wave_track defense.wave matches 8 run function core:defense/monsters/summon/skeleton_horse
execute if score $wave_track defense.wave matches 1..8 run schedule function core:defense/monsters/waves/wave18 3s

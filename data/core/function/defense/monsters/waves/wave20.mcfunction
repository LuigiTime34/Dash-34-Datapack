...
execute if score $wave_track defense.wave matches 4 run function core:defense/monsters/boss/iron_golem_boss/summon
...
execute if score $wave_track defense.wave matches 1..6 run schedule function core:defense/monsters/waves/wave20 3s

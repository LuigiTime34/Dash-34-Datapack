...
execute if score $wave_track defense.wave matches 9 run function core:defense/monsters/summon/charged_creeper
...
execute if score $wave_track defense.wave matches 1..13 run schedule function core:defense/monsters/waves/wave49 3s

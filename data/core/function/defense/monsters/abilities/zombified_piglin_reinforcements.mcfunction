...
summon zombified_piglin ~ ~ ~ {CustomNameVisible:1b,Health:25,NoAI:1b,Rotation:[90f,0.0f],Tags:["defense-monster","cw_hp_disp","defense-zombified_piglin","Entity-Dummy","defense-new_piglin"],Team:defense_enemies,attributes:[{id:"max_health",base:30},{id:"minecraft:attack_damage",base:0},{id:"minecraft:attack_knockback",base:190},{id:"minecraft:armor",base:0}],PersistenceRequired:1b}

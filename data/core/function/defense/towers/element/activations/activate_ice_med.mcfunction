...
$execute if score @s defense.element_random matches 1..70 as @n[tag=defense-monster,tag=defense-target] at @s run function core:defense/towers/element/ice/freeze {"damage":"$(ice_damage)","freeze_time":"$(freeze_time)","freeze_power":"$(freeze_power)"}

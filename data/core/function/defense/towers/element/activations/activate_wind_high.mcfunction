...
$execute as @n[tag=defense-monster,tag=defense-target] at @s run function core:defense/towers/element/wind/blow_back_but_lightning {"damage":"$(wind_damage)","blow_power":"$(blow_power)"}
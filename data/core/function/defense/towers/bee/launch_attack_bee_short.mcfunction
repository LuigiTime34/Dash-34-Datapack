...
execute as @e[tag=defense.bee_deployer,distance=..4.95] at @s anchored eyes positioned ^ ^ ^ positioned ~ -58.9 ~ anchored feet run function core:defense/towers/bee/raycast_short/start_ray

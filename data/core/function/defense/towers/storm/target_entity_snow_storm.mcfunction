...
$execute as @n[tag=defense-monster,tag=defense-target] at @s run function core:defense/towers/storm/blow_back_freeze_storm {"damage":"$(damage)","blow_power":"$(blow_power)"}
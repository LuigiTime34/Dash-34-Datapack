...
$execute as @n[tag=defense-monster,tag=defense-target,tag=defense-breeze] run return run function core:defense/monsters/abilities/breeze_find_target {"damage":"$(damage)"}

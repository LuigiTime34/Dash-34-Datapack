...
execute at @s anchored eyes positioned ^ ^ ^ facing entity @n[tag=defense-monster,tag=defense-target] feet run function core:defense/towers/archer/raycast_potion/start_ray

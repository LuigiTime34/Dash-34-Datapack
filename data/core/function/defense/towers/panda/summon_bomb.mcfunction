...
execute at @n[tag=defense-target] anchored eyes positioned ^ ^ ^1.5 run summon marker ~ -59 ~ {Tags:["defense.panda_landing","defense.panda_new_landing"]}
...
$scoreboard players set @n[tag=defense.panda_tnt] defense.panda_boo_damage $(damage)
$scoreboard players set @n[tag=defense.panda_tnt] defense.panda_bomb_range $(bomb_range)
$scoreboard players set @n[tag=defense.panda_landing] defense.panda_bomb_range $(bomb_range)

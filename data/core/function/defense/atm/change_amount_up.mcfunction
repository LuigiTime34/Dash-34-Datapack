...
execute unless score $emerald_cost defense.money matches 10 run scoreboard players add $gold_cost defense.money 25
...
execute positioned -67 -59 106 if score $emerald_cost defense.money matches 10 run return run playsound minecraft:block.note_block.didgeridoo master @a ~ ~ ~ 2
...
execute positioned -67 -59 106 if score $emerald_cost defense.money matches 10 run playsound minecraft:block.note_block.bit master @a ~ ~ ~ 2 1.4